...
class StoriesTestCase(unittest.TestCase):
    ...
    def test_1_upload_a_story(self):
        ...
        result = self.client.post('/api/flashstories', headers=headers, data=json.dumps(storyInfo), content_type='application/json')
    ...
    def test_2_get_my_story(self):
        ...
        result = self.client.get('/api/flashstories', headers=headers, data=json.dumps(info), content_type='application/json')
    ...
    def test_4_update_my_story(self):
        ...
        result_update = self.client.put('/api/flashstories', headers=headers, data=json.dumps(updatedInfo), content_type='application/json')
    ...
    def test_7_delete_my_story(self):
        ...
        result = self.client.delete('/api/flashstories', headers=headers2, data=json.dumps({"id":id}), content_type='application/json')
    ...
    def test_9_my_story_deletes_itself(self):
        # Asume user exists
        loginInfo = {
            "username": "user",
            "password": "password"
        ...
        # Wait for 1 second para que se borre la historia
        time.sleep(1);
        ...
        listHistorias = dataDict["feedStories"];
        storyExists = False;
        for i in listHistorias:
            if i["_id"]== id:
                storyExists = True;
                # print (listHistorias[i]);
                # print (i["_id"])

        self.assertFalse(storyExists)
